package com.yutai.business.ugee.ui.common
...
class DefaultTopTitleBarWhite : RelativeLayout {
    ...
    private fun retrieveAttributes(attrs: AttributeSet?){
        ...
        //设置左侧文本(默认隐藏)
        //隐藏-false 显示-true
        val textLeftSize = typedArray.getFloat(R.styleable.CustomTopTitleBar_ctb_show_text_left_size,16.0f)
        tvLeft.textSize = textLeftSize
